    ...
    <section className='relative flex lg:flex-row flex-col max-container'>
      ...
      <div className='flex-1 min-w-[50%] flex flex-col'>
        ...
        <form className='w-full flex flex-col gap-7 mt-14' onSubmit={handleSubmit}>
          ...
          <input type="text" name='email' className='input' placeholder='Enter your email' required value={form.email} onChange={handleChange} onFocus={handleFocus} onBlur={handleBlur}/>

          </label>
          <label htmlFor="" className='text-black-500 font-semibold'>Your Message

          <textarea name='message' rows={4} className='input' placeholder='Let me know how can I help you!' required value={form.message} onChange={handleChange} onFocus={handleFocus} onBlur={handleBlur}/>

          </label>

          <button type='submit' className='btn' onFocus={handleFocus} 
          disabled={isLoading} onBlur={handleBlur}>
